...
print('компьютер загадал четырехзначное число,если вы угадали число но оно не на том месте то,компьютер скажет что есть корова.если число на том же месте то это бык')
